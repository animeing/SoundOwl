<template>
    <div>
        ...
        <SlideComponet :slide-title="'Sound Top 20'" :data-request="soundCountRequest" :context-menu="soundContext" :item-click="soundClipClick"></SlideComponet>
        <SlideComponet :slide-title="'Album Top 20'" :data-request="albumCountRequest" :item-click="albumClipClick"></SlideComponet>
    </div>
</template>
<script>
